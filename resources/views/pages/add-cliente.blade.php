                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <div class="card">
                            ...
                            <div class="card-body">  
                                <form action="{{route('cliente-store')}}" method="post" enctype="multipart/form-data" class="multisteps-form__form" style="height: 273px;">
                                @csrf
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                    <div class="input-group input-group-dynamic">
                                                        ...
                                                        <input name="cidade" class="multisteps-form__input form-control" type="text"
                                                            onfocus="focused(this)" onfocusout="defocused(this)">
                                                    </div>
                                                </div>
                                            </div>
